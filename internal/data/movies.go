...
func (m MovieModel) Insert(movie *Movie) error {
	...
	// Use the QueryRow() method to execute the SQL query on our connection pool, passing
	// in the args slice as a variadic parameter and scanning the system-generated id,
