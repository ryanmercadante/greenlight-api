...
// Update method for updating a specific record from the movies table.
...
func (m MovieModel) Delete(id int64) error {
	...
	// Execute the SQL query using the ExecContext() method, passing in the id variable as
	// the value for the placeholder parameter. The ExecContext() method returns a sql.Result
	// object.
...
// GetAll() method which returns a slice of movies.
func (m MovieModel) GetAll(title string, genres []string, filters Filters) ([]*Movie, error) {
	...
	for rows.Next() {
		// Initialize an empty Movie struct to hold the data for an individual model.
		var movie Movie
